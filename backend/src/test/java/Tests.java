...
public class Tests {
    ...
    {
        assertEquals(3, nthRoot(81, 4, 0.0000001), 0.0001);
        assertEquals(0.83255320, nthRoot(0.4, 5, 0.0000001), 0.0001);
        assertEquals(0, nthRoot(0, 4, 0.000001), 0.000001);
        assertEquals(0.56234132, nthRoot(0.001, 12, 0.0000001), 0.0001);
    }
    ...
    public void testMortageClass()
    {
        ...
        assertEquals(3764.079674, m1.monthlyPayment, 0.0001);
        assertEquals(0.004074123, m1.monthlyInterest, 0.0001);
        assertEquals(500000.0 / (15 * 12), m2.monthlyPayment, 0.0001);
